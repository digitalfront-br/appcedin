...
import { useVideos, useLoading, useTema } from '../../../services/providers/AppProvider'
                ...
                <>
                    <ScrollView style={Style.container}>
                        ...
                        <View>
                            ...
                            <View>
                                {videos && videos.map(res => res.itens && res.itens == '' ? <Text style={{ position: 'absolute', bottom: 0, height: 0, width: 0, borderWidth: 0 }} key={res.id}></Text> :
